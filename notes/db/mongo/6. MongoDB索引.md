...
### [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#mongodb-索引有什么用)MongoDB 索引有什么用?
...
### [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#mongodb-支持哪些类型的索引)MongoDB 支持哪些类型的索引？
...
### [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#复合索引中字段的顺序有影响吗)复合索引中字段的顺序有影响吗？

复合索引中字段的顺序非常重要，例如下图中的复合索引由`{userid:1, score:-1}`组成，则该复合索引首先按照`userid`升序排序；然后再每个`userid`的值内，再按照`score`降序排序。

![复合索引](https://oss.javaguide.cn/github/javaguide/database/mongodb/mongodb-composite-index.png)复合索引
...
### [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#复合索引遵循左前缀原则吗)复合索引遵循左前缀原则吗？
...
### [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#什么是-ttl-索引)什么是 TTL 索引？
...
### [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#什么是覆盖索引查询)什么是覆盖索引查询？
...
## [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#mongodb-高可用)MongoDB 高可用

### [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#复制集群)复制集群

#### [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#什么是复制集群)什么是复制集群？
...
![img](https://oss.javaguide.cn/github/javaguide/database/mongodb/replica-set-read-write-operations-primary.png)
...
![img](https://oss.javaguide.cn/github/javaguide/database/mongodb/replica-set-primary-with-two-secondaries.png)
...
#### [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#为什么要用复制集群)为什么要用复制集群？
...
### [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#分片集群)分片集群

#### [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#什么是分片集群)什么是分片集群？

分片集群是 MongoDB 的分布式版本，相较副本集，分片集群数据被均衡的分布在不同分片中， 不仅大幅提升了整个集群的数据容量上限，也将读写的压力分散到不同分片，以解决副本集性能瓶颈的难题。

MongoDB 的分片集群由如下三个部分组成（下图来源于[官方文档对分片集群的介绍open in new window](https://www.mongodb.com/docs/manual/sharding/)）：

![img](https://oss.javaguide.cn/github/javaguide/database/mongodb/sharded-cluster-production-architecture.png)
...
#### [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#为什么要用分片集群)为什么要用分片集群？
...
#### [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#什么是分片键)什么是分片键？
...
#### [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#如何选择分片键)如何选择分片键？

选择合适的片键对 sharding 效率影响很大，主要基于如下四个因素（摘自[分片集群使用注意事项 - - 腾讯云文档open in new window](https://cloud.tencent.com/document/product/240/44611)）：
...
#### [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#分片策略有哪些)分片策略有哪些？

MongoDB 支持两种分片算法来满足不同的查询需求（摘自[MongoDB 分片集群介绍 - 阿里云文档open in new window](https://help.aliyun.com/document_detail/64561.html?spm=a2c4g.11186623.0.0.3121565eQhUGGB#h2--shard-key-3)）：

**1、基于范围的分片**：

![img](https://oss.javaguide.cn/github/javaguide/database/mongodb/example-of-scope-based-sharding.png)
...
#### [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#分片数据如何存储)分片数据如何存储？
...
![Chunk 分裂](https://oss.javaguide.cn/github/javaguide/database/mongodb/chunk-splitting-shard-a.png)Chunk 分裂
...
![Chunk 迁移](https://oss.javaguide.cn/github/javaguide/database/mongodb/mongo-reblance-three-shards.png)Chunk 迁移
...
#### [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#chunk-迁移原理是什么)Chunk 迁移原理是什么？

关于 Chunk 迁移原理的详细介绍，推荐阅读 MongoDB 中文社区的[一文读懂 MongoDB chunk 迁移open in new window](https://mongoing.com/archives/77479)这篇文章。

## [#](https://javaguide.cn/database/mongodb/mongodb-questions-02.html#学习资料推荐)学习资料推荐

-   [MongoDB 中文手册|官方文档中文版open in new window](https://docs.mongoing.com/)（推荐）：基于 4.2 版本，不断与官方最新版保持同步。
-   [MongoDB 初学者教程——7 天学习 MongoDBopen in new window](https://mongoing.com/archives/docs/mongodb初学者教程/mongodb如何创建数据库和集合)：快速入门。
-   [SpringBoot 整合 MongoDB 实战 - 2022open in new window](https://www.cnblogs.com/dxflqm/p/16643981.html)：很不错的一篇 MongoDB 入门文章，主要围绕 MongoDB 的 Java 客户端使用进行基本的增删改查操作介绍。