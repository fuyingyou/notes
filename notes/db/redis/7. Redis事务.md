...
### [#](https://javaguide.cn/database/redis/redis-questions-02.html#什么是-redis-事务)什么是 Redis 事务？
...
### [#](https://javaguide.cn/database/redis/redis-questions-02.html#如何使用-redis-事务)如何使用 Redis 事务？
...
### [#](https://javaguide.cn/database/redis/redis-questions-02.html#redis-事务支持原子性吗)Redis 事务支持原子性吗？
...
### [#](https://javaguide.cn/database/redis/redis-questions-02.html#redis-事务支持持久性吗)Redis 事务支持持久性吗？
...
### [#](https://javaguide.cn/database/redis/redis-questions-02.html#如何解决-redis-事务的缺陷)如何解决 Redis 事务的缺陷？
...
## [#](https://javaguide.cn/database/redis/redis-questions-02.html#redis-性能优化-重要)Redis 性能优化（重要）
...
### [#](https://javaguide.cn/database/redis/redis-questions-02.html#使用批量操作减少网络传输)使用批量操作减少网络传输
...
#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#原生批量操作命令)原生批量操作命令
...
#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#pipeline)pipeline
...
#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#lua-脚本)Lua 脚本
...
### [#](https://javaguide.cn/database/redis/redis-questions-02.html#大量-key-集中过期问题)大量 key 集中过期问题
...
### [#](https://javaguide.cn/database/redis/redis-questions-02.html#redis-bigkey-大-key)Redis bigkey（大 Key）

#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#什么是-bigkey)什么是 bigkey？
...
#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#bigkey-有什么危害)bigkey 有什么危害？

bigkey 除了会消耗更多的内存空间和带宽，还会对性能造成比较大的影响。因此，我们应该尽量避免 Redis 中存在 bigkey。

#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#如何发现-bigkey)如何发现 bigkey？
...
#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#如何处理-bigkey)如何处理 bigkey？
...
### [#](https://javaguide.cn/database/redis/redis-questions-02.html#redis-hotkey-热-key)Redis hotkey（热 Key）

#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#什么是-hotkey)什么是 hotkey？
...
#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#hotkey-有什么危害)hotkey 有什么危害？

处理 hotkey 会占用大量的 CPU 和带宽，可能会影响 Redis 实例对其他请求的正常处理。此外，如果突然访问 hotkey 的请求超出了 Redis 的处理能力，Redis 就会直接宕机。这种情况下，大量请求将落到后面的数据库上，可能会导致数据库崩溃。

因此，hotkey 很可能成为系统性能的瓶颈点，需要单独对其进行优化，以确保系统的高可用性和稳定性。

#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#如何发现-hotkey)如何发现 hotkey？
...
#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#如何解决-hotkey)如何解决 hotkey？
...
### [#](https://javaguide.cn/database/redis/redis-questions-02.html#慢查询命令)慢查询命令

#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#为什么会有慢查询命令)为什么会有慢查询命令？
...
#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#如何找到慢查询命令)如何找到慢查询命令？
...
### [#](https://javaguide.cn/database/redis/redis-questions-02.html#redis-内存碎片)Redis 内存碎片
...
## [#](https://javaguide.cn/database/redis/redis-questions-02.html#redis-生产问题-重要)Redis 生产问题（重要）

### [#](https://javaguide.cn/database/redis/redis-questions-02.html#缓存穿透)缓存穿透

#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#什么是缓存穿透)什么是缓存穿透？
...
#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#有哪些解决办法)有哪些解决办法？
...
### [#](https://javaguide.cn/database/redis/redis-questions-02.html#缓存击穿)缓存击穿

#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#什么是缓存击穿)什么是缓存击穿？
...
#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#有哪些解决办法-1)有哪些解决办法？

-   设置热点数据永不过期或者过期时间比较长。
-   针对热点数据提前预热，将其存入缓存中并设置合理的过期时间比如秒杀场景下的数据在秒杀结束之前不过期。
-   请求数据库写数据到缓存之前，先获取互斥锁，保证只有一个请求会落到数据库上，减少数据库的压力。

#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#缓存穿透和缓存击穿有什么区别)缓存穿透和缓存击穿有什么区别？

缓存穿透中，请求的 key 既不存在于缓存中，也不存在于数据库中。

缓存击穿中，请求的 key 对应的是 **热点数据** ，该数据 **存在于数据库中，但不存在于缓存中（通常是因为缓存中的那份数据已经过期）** 。

### [#](https://javaguide.cn/database/redis/redis-questions-02.html#缓存雪崩)缓存雪崩

#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#什么是缓存雪崩)什么是缓存雪崩？
...
#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#有哪些解决办法-2)有哪些解决办法？
...
#### [#](https://javaguide.cn/database/redis/redis-questions-02.html#缓存雪崩和缓存击穿有什么区别)缓存雪崩和缓存击穿有什么区别？

缓存雪崩和缓存击穿比较像，但缓存雪崩导致的原因是缓存中的大量或者所有数据失效，缓存击穿导致的原因主要是某个热点数据不存在与缓存中（通常是因为缓存中的那份数据已经过期）。

### [#](https://javaguide.cn/database/redis/redis-questions-02.html#如何保证缓存和数据库数据的一致性)如何保证缓存和数据库数据的一致性？
...
### [#](https://javaguide.cn/database/redis/redis-questions-02.html#哪些情况可能会导致-redis-阻塞)哪些情况可能会导致 Redis 阻塞？
...
## [#](https://javaguide.cn/database/redis/redis-questions-02.html#redis-集群)Redis 集群
...
## [#](https://javaguide.cn/database/redis/redis-questions-02.html#redis-使用规范)Redis 使用规范
